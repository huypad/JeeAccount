...
import { UserChatBox } from 'src/app/pages/JeeAccount/my-chat/models/user-chatbox';
...
export class MessengerComponent implements OnInit, OnDestroy, OnChanges {
  ...
  unReadMessageFromSenderUsername(IdGroup: any) {
    ...
    if (index >= 0 && this.lstContact[index].Active === 1 && this.lstContact[index].isGroup == false && check < 0) {
