...
namespace JeeAccount.Services.CommentService
{
    public class CommentService : ICommentService
    {
        ...
        public async Task<string> GetTopicObjectID(string componentName)
        {
        ...
        public async Task<HttpResponseMessage> CreateTopicObjectID(string username, string access_token)
        {
        ...
        public void UpdateTopicID(string componenName, string topicID)
        {
        ...
        public void SaveTopicID(string componenName, string topicID)
        {
            Hashtable val = new Hashtable();
            try
            {
                ...
                using (DpsConnection cnn = new DpsConnection(_connectionString))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        UpdateTopicID(componenName, topicID);
                        return;
                    }
        ...
        public async Task PostCommentKafka(PostCommentModel postComment)
        {
